...
class OrcamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orcamento" do
    assert_difference("Orcamento.count") do
      post orcamentos_url, params: { orcamento: { cnpj: @orcamento.cnpj, codigo: @orcamento.codigo, descricao: @orcamento.descricao, nome: @orcamento.nome, quantidade: @orcamento.quantidade, valor: @orcamento.valor } }
    end
  ...
  test "should update orcamento" do
    patch orcamento_url(@orcamento), params: { orcamento: { cnpj: @orcamento.cnpj, codigo: @orcamento.codigo, descricao: @orcamento.descricao, nome: @orcamento.nome, quantidade: @orcamento.quantidade, valor: @orcamento.valor } }
